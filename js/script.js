  ...
  init: function () {
          ...
          var response = function(user) {
                var displayResult = '<ul>';
                    ...
                    displayResult += '<p style="color:blue;">RESULTS:</p>';
